            ...
            if (obj.settings.ctaTest === 'viewBy'){
                ...
                $(
                    $('<a/>')
                        ...
                        .append('<span class="button__vto__text--grey-button">ADD TO BAG</span>')
                    ).prependTo('.viewBy')            
                ...
                $(
                    $('<a/>')
                        ...
                        .append('<span class="button__vto__text">ADD TO BAG</span>')
